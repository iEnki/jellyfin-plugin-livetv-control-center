...
Release verification completed: both GitHub Build and Beta release workflows succeeded for commit 8044941513097e1874a46c6bae44033ffc7e3af7. Release https://github.com/iEnki/jellyfin-plugin-livetv-groups/releases/tag/v0.3.3.2-beta is published (prerelease=true, draft=false). ZIP checksum matches beta-channel/manifest-beta.json, source URL points to the beta ZIP, target ABI is 12.0.0.0, DLL version is 0.3.3.2 and ProductVersion is 0.3.3.2-beta+8044941513097e1874a46c6bae44033ffc7e3af7. The version release includes the beta manifest; the existing development catalog also contains 0.3.3.2. Stable main remains 8033de45d56c0a77b4ca759deab0129c29fe408b. All five phases are implemented and reviewed. Physical TV acceptance remains the documented beta limitation.
